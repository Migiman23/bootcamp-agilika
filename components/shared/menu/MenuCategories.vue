...
<!-- Este es el menú de categorias que se despliega hacia abajo -->
...
export default {
    ...
    computed: {
        // ...mapState({
            // categorias: state => state.product.categories
        // })
    },
    data() {
        return {
            categorias: [
                ...
                {
                    icon: 'icon-star',
                    text: 'Cell Phones, Smart Watches & Accessories',
                    url: '/shop'
                },
                   {
                    icon: 'icon-star',
                ...
                {
                    icon: 'icon-star',
                    text: 'Surveillance & Smart Home Electronics',
                    url: '/shop'
                },
                   {
                    icon: 'icon-star',
                    text: 'Vehicle Electronics & GPS',
                    url: '/shop'
                },
                {
                    icon: 'icon-star',
                ...
                {
                    icon: 'icon-star',
                    text: 'Virtual Reality Headsets, Parts & Accessories',
                    url: '/shop'
                },
            ],
            menuCategories: [
