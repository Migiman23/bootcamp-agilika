<template>
    <div class="mt-4 container">
        <h2 class="text-center">Shipment detail</h2>
        <v-row dense class="mb-4 mt-5">
            <v-col cols-3 style="max-width: 600px;">
                <h3>Product list</h3>
                <v-expansion-panels focusable>
                    <v-expansion-panel v-for="(item, i) in 5" :key="i">
                        <v-expansion-panel-header
                            ><h6>PRODUCT {{'#'+ Number(i+1)}}</h6>
                        </v-expansion-panel-header>
                        ...
                        <v-expansion-panel-content>
                            <div>
                                ...
                                <v-btn x-small color="error" class="float-right">Cancel</v-btn>
                            </div>
                        </v-expansion-panel-content>
                    </v-expansion-panel>
                </v-expansion-panels>
            ...
            <v-col cols="3">
                ...
                >
                    ...
                    <v-timeline-item class="mb-4" color="grey" small>
                        <v-row justify="space-between">
                            <v-col cols="7">
                                A $15.00 USD payment was processed on PayPal
                                Express Checkout
                            </v-col>
                            <v-col class="text-right" cols="5">
                                15:25 EDT
